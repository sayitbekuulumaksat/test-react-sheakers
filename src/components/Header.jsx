    ...
    <div className=' flex items-center justify-between border-b border-gray-200 p-5'>
      <Link to='/' className='logo flex items-center gap-5'>
        ...
        <div className='logo__text'>
          <strong className='uppercase text-2xl'>React sneakers</strong>
      ...
      <div className='flex items-center gap-10'>
        ...
        >
          <SlBasket /> <span className='font-semibold'>1205 rub</span>
        </Link>
        <Link
          to='bookmarks'
          className='flex items-center gap-2 cursor-pointer hover:scale-110'
        >
          <SlHeart /> <span>Закладки</span>
        </Link>
        <Link
          to='/'
          className='flex items-center gap-2 cursor-pointer hover:scale-110'
        >
          <SlUser /> <span>Профиль</span>
        </Link>
      </div>
    </div>
  );
